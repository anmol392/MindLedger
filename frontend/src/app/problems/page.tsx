    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div className="flex flex-col gap-4">
          <h1 className="text-4xl font-bold tracking-tight text-foreground uppercase sm:text-5xl">Problem Marketplace</h1>
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full rounded-2xl bg-muted border border-border pl-12 pr-4 py-3 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all shadow-sm"
            />
          </div>
          <button className="flex h-[46px] items-center gap-2 rounded-2xl bg-muted border border-border px-6 text-sm font-bold text-foreground hover:bg-secondary transition-all shadow-sm">
            ...
            <div className="flex flex-wrap gap-2 lg:flex-col lg:gap-1">
              {subjects.map((subject) => (
                <button
                  ...
                  className={`flex items-center justify-between px-4 py-2 text-sm font-medium transition-all rounded-lg ${
        ...
        <div className="flex-1">
          ...
          {filteredProblems.length === 0 && (
            <div className="mt-20 flex flex-col items-center text-center">
              <div className="size-20 rounded-3xl bg-muted flex items-center justify-center border border-border mb-6">
